...
| **torah** | Estudo da Torá (parashá, reflexão) | 0.2 | `daily/torah/AGENT.md` | `daily/torah/cache.json` |
...
| 08:30 | Google Skills (2x/semana) | `[MATERIAL]` → `[VOCÊ ESTUDA]` |
| 09:00-11:00 | Deep work — user trabalha | `[FUNDO]` |
| 11:00 | Python — user estuda | `[MATERIAL]` → `[VOCÊ ESTUDA]` |
| 12:00-14:00 | Almoço | `[FUNDO]` |
| 14:00-17:00 | Deep work | `[FUNDO]` |
| 17:00 | Portfólio | `[FAÇO]` |
| 18:00-20:00 | Livre | `[FAÇO]` |
| 20:00 | Torá + Filosofia | `[MATERIAL]` → `[VOCÊ ESTUDA]` |
