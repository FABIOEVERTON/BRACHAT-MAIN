...
*   Nenhum código entra em produção sem o arquivo [@implementation_plan.md](brachat-main/builder/GOVERNANCE_WORKFLOW.md) de especificação associado.
...
*   O Git Hook valida se o commit provém de um terminal autorizado e se a tarefa de desenvolvimento correspondente está com status `Development` ativo no ClickUp.
