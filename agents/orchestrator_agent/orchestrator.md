...
- **Unique CPF/ID**: Every agent in the ecosystem MUST possess a unique Identification Code (CPF/ID) in their configuration frontmatter and memory context:
  ...
  - **JOHN**: `BR-JOHN-020` (English Studies)
  - **DEV**: `BR-DEV-021` (Python Studies)
  - **TEMER**: `BR-TEMER-022` (Politics Studies)
  - **ARISTOTLE**: `BR-ARISTO-023` (Philosophy Studies)
  - **EDUARDO**: `BR-EDUARD-024` (PMP Studies)
  - **GOOGLE**: `BR-GOOGLE-025` (Google Skills Studies)
  ...
  - **BADGE**: `BR-BADGE-030` (Certifications Studies)
  - **PORTUGUESE**: `BR-PORTUG-031` (Portuguese Studies)
