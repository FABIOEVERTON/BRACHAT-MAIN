...
│   │
│   ├── orchestrator_agents/                    ← EZRA — THE BRAIN
...
│   │
│   ├── production_planning_agents/             ← 2 BUILDERS
...
│   └── politica/summaries/
│
├── .cloud/                                     ← CLOUD INFRASTRUCTURE (Hidden)
│   ├── agents/README.md
...
│   │   ├── job-hunter.sh                       ← Job hunter execution
│   │   ├── mem0-heartbeat.sh                   ← Memory consolidation heartbeat
│   │   └── advance_schedule.py                 ← Schedule day progression
...
│   ├── engineer/                               ← BARUCH — LEAD SOFTWARE ENGINEER
│   │   ├── CLAUDE.md                           ← Core memory rules
│   │   └── baruch.md                           ← Baruch identity and Obsidian DevLogs
│   ├── products/
│   ├── README.md
│   └── state.json
│
...
**`agents/production_planning_agents/`** — 2 Builders
...
- `engineer/baruch.md` — Baruch, Lead Software Engineer. Reads state.json locally, writes project code, and uses `obsidian-skills` to natively generate `DevLog.md` directly into the Obsidian Vault.
